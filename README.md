[![Netlify Status](https://api.netlify.com/api/v1/badges/9f2f756f-e1fc-48d9-9c07-b7d7433d8aaa/deploy-status)](https://app.netlify.com/sites/stunning-tulumba-5f236c/deploys)
# ☕STARBUCKS

스타벅스 랜딩 페이지(홈페이지)를 만드는 예제입니다. <br />
꼭 👇 아래 내용 모두 읽어보시고, 👆 완성된 코드도 확인해 보세요! 

[main(master) 브랜치로 이동](https://github.com/joosang425/Starbucks) <br />
[sign 브랜치로 이동](https://github.com/joosang425/Starbucks/tree/feature/signin) 

[DEMO](https://stunning-tulumba-5f236c.netlify.app) <br />
[DEMO+singin](https://stunning-tulumba-5f236c.netlify.app/signin)

![스타벅스 예제](https://github.com/joosang425/Starbucks/assets/68217970/a7fb8fb1-2cbe-4350-90d5-f2dfff7a6933)
...
웹 페이지가 화면(Viewport)에 표현되는 방식을 설정합니다. <br />
모바일 환경에서 적용됩니다. 
...
## 오픈 그래프(The Open Grapth protocol)
웹 페이지가 소셜 미디어(페이스북 등)로 공유될 때 우선적으로 활용되는 정보를 지정합니다. <br />
카카오톡 - <br /> 
![스타벅스_카카오톡](https://github.com/joosang425/Starbucks/assets/68217970/3c3870aa-d385-4328-ab0b-49fce3794b12)
